...
class User(db.Model):
    ...
    password: Mapped[str] = mapped_column(sa.String(20), nullable=False)
...
class Post(db.Model):
    ...
    create_at: Mapped[datetime] = mapped_column(sa.DateTime, nullable=False, default=lambda: datetime.now(timezone.utc))
